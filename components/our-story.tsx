  ...
  const storyEvents = [
    {
      title: "พบกันครั้งแรก",
      date: "พฤษภาคม 2563",
      description: "เราพบกันครั้งแรกที่งานวันเกิดของเพื่อน เจมส์ทำเครื่องดื่มหกใส่ชุดของโซเฟีย และนั่นคือจุดเริ่มต้นของบทสนทนาของเรา",
    ...
    },
    {
      title: "การขอแต่งงาน",
      date: "ธันวาคม 2566",
      description: "เจมส์ขอโซเฟียแต่งงานระหว่างทริปที่ภูเก็ต เป็นช่วงพระอาทิตย์ตกที่ชายหาด พร้อมแหวนสวยงามและน้ำตาแห่งความสุข",
      image: "/images/wed5.jpg??height=400&width=400",
    },
  ]
